  ...
  return (
    <div className={styles.find}>
        <div className={styles.heading}>
            <h1>Find Your Drives</h1>
            <div className={styles.text_bg}>
            <p>
                <span>Explore the Worlds Largest cars Sharing marketplace</span>
            </p>
            </div>
        </div>
        <div className={styles.slider_container}>
           <Swiper
            ...
            onSlideChange={() => console.log('slide change')}>
              ...
              <SwiperSlide>
                <Card image='https://media.istockphoto.com/id/519439159/photo/black-3d-car.jpg?s=2048x2048&w=is&k=20&c=Hyq-pwi9foFFe6_oYqDHXMooECfnoeKU-aHRswEY8OE='
                make="audi"/>
              </SwiperSlide>
              <SwiperSlide>
            <Card
